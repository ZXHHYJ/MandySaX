package mandysax.navigationbar.widget;
...
import mandysax.core.utils.DensityUtils;
...
public final class NavigationItem extends LinearLayout
{
    ...
    private void initViews(Context context)
	{
        ...
        //设置本身的布局
        LinearLayout.LayoutParams selfParam = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, 1f);
