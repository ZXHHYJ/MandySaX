...
internal class LegacyCanvasSaveProxy(private var canvas: Canvas) : CanvasSaveProxy {
        ...
        get() {
            ...
            return try {
                ...
                throw IllegalStateException(
                    "Failed to get value of $FIELD_NAME - NoSuchFieldException",
                    e
                )
            } catch (e: IllegalAccessException) {
                throw IllegalStateException(
                    "Failed to get value of $FIELD_NAME - IllegalAccessException",
                    e
                )
            }
        }
    ...
    private fun invokeSave(): Int {
        return try {
            ...
            throw IllegalStateException(
                "Failed to execute save(int) - InvocationTargetException",
                e
            )
        }
    }
