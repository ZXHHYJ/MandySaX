    ...
    override fun getPosition(view: RecyclerView, isSlidingUp: Boolean): Int {
        ...
        return when {
            ...
            isSlidingUp -> {
                ...
                view.getChildLayoutPosition(firstChild) * lm!!.getDecoratedMeasuredHeight(firstChild) - lm.getDecoratedTop(
                    firstChild
                )
            }
            else -> {
                ...
                (view.adapter!!.itemCount - 1) * lm!!.getDecoratedMeasuredHeight(lastChild) + lm.getDecoratedBottom(
                    lastChild
                ) - view.bottom
            }
        }
