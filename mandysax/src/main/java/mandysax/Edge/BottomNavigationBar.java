...
public class BottomNavigationBar extends LinearLayout {
    ...
    public static final int DEFAULT_UNCHECKED_IMAGE = R.mipmap.ic_android_black_24dp;
    public static final int DEFAULT_CHECKED_IMAGE = R.mipmap.ic_android_green_24dp;
